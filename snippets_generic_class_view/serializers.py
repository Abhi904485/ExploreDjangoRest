...
from .models import SnippetGenericClassView, LANGUAGE_CHOICES, STYLE_CHOICES

from rest_framework import serializers


class SimpleGenericClassViewSnippetSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        :return:
        """
        return SnippetGenericClassView.objects.create(**validated_data)
