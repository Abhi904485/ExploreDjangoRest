...
from .models import SnippetMixinClassView, LANGUAGE_CHOICES, STYLE_CHOICES

from rest_framework import serializers


class SimpleMixinClassViewSnippetSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        :return:
        """
        return SnippetMixinClassView.objects.create(**validated_data)
