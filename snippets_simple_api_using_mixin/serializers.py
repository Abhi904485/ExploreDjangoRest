...
from .models import SnippetApiMixinView, LANGUAGE_CHOICES, STYLE_CHOICES

from rest_framework import serializers


class SimpleMixinApiViewSnippetSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        :return:
        """
        return SnippetApiMixinView.objects.create(**validated_data)
