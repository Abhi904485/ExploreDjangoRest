...
from .models import SnippetApiMixinViewSet, LANGUAGE_CHOICES, STYLE_CHOICES

from rest_framework import serializers


class SimpleMixinViewSetSnippetSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        :return:
        """
        return SnippetApiMixinViewSet.objects.create(**validated_data)
