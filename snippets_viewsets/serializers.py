...
from .models import SnippetViewSet, LANGUAGE_CHOICES, STYLE_CHOICES

from rest_framework import serializers


class SimpleViewSetSnippetSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        :return:
        """
        return SnippetViewSet.objects.create(**validated_data)
